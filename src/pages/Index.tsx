      ...
      <div className="min-h-screen relative overflow-x-hidden">
              ...
              <div className="space-y-6">
                ...
                <ScrollReveal delay={300} animation="fade-in-right">
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                    Hi, I'm <span className="gradient-text">Paresh Bavaliya</span>
                  </h1>
                </ScrollReveal>
                
                <ScrollReveal delay={600} animation="fade-in-right">
                  <p className="text-lg text-gray-600 dark:text-gray-300">
                    Enthusiastic React Developer building immersive web experiences.
                  </p>
                </ScrollReveal>
        ...
        <section id="about" className="py-20 relative">
          <div className="section-container">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
              <div className="bg-blob bg-theme-purple/10 w-64 h-64 rounded-full absolute -left-20 top-20 animate-float" style={{ animationDelay: '0s' }}></div>
              <div className="bg-blob bg-theme-blue/10 w-96 h-96 rounded-full absolute -right-40 bottom-20 animate-float" style={{ animationDelay: '1s' }}></div>
              <div className="bg-blob bg-theme-purple/5 w-48 h-48 rounded-full absolute left-1/3 top-1/2 animate-pulse-glow" style={{ animationDelay: '1.5s' }}></div>
            </div>
            ...
            <div className="glass-card p-8 rounded-2xl max-w-3xl mx-auto relative z-10 backdrop-blur-sm shadow-xl border border-white/20 dark:border-gray-800/50 hover:shadow-theme-purple/20 transition-all duration-500">
              <ScrollReveal animation="fade-in">
                <p className="text-lg mb-6 relative">
                  <span className="inline-block text-2xl text-theme-purple font-semibold mr-2">👋</span>
                  Hello! I'm a dedicated React developer with a passion for creating responsive, 
                  dynamic applications that users love to interact with.
                </p>
              </ScrollReveal>
                  ...
                  <ul className="space-y-3 pl-10 border-l-2 border-theme-blue/30 py-2">
                    {activeTyping >= 1 && (
                      <li className="flex items-start animate-fade-in" style={{ animationDelay: '100ms' }}>
                        ...
                        <span>I focus on creating clean, maintainable code</span>
                      </li>
                    )}
                    {activeTyping >= 1 && (
                      <li className="flex items-start animate-fade-in" style={{ animationDelay: '300ms' }}>
                        ...
                        <span>I prioritize responsive design and accessibility</span>
                      </li>
                    )}
                    {activeTyping >= 1 && (
                      <li className="flex items-start animate-fade-in" style={{ animationDelay: '500ms' }}>
                        <span className="w-5 h-5 rounded-full bg-theme-purple/20 flex items-center justify-center mr-2 mt-0.5 flex-shrink-0">
                          <span className="w-2 h-2 rounded-full bg-theme-purple"></span>
                        </span>
                        <span>I'm constantly learning new technologies and techniques</span>
                      </li>
                    )}
                    {activeTyping >= 1 && (
                      <li className="flex items-start animate-fade-in" style={{ animationDelay: '700ms' }}>
                        <span className="w-5 h-5 rounded-full bg-theme-purple/20 flex items-center justify-center mr-2 mt-0.5 flex-shrink-0">
                          <span className="w-2 h-2 rounded-full bg-theme-purple"></span>
                        </span>
                        <span>I believe in the power of collaboration and open communication</span>
                      </li>
                    )}
                  </ul>
                </div>
        ...
        <section id="experience" className="py-20 relative">
          <div className="section-container">
            ...
            {/* Animated background elements */}
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
              <div className="bg-blob bg-theme-blue/10 w-64 h-64 rounded-full absolute -left-20 top-40 animate-float" style={{ animationDelay: '0.5s' }}></div>
              <div className="bg-blob bg-theme-purple/10 w-96 h-96 rounded-full absolute -right-40 bottom-10 animate-float" style={{ animationDelay: '1.2s' }}></div>
            </div>
              ...
              <ScrollReveal delay={400} animation="fade-in">
                <div className="flex items-center justify-center gap-4 p-4 mt-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-center italic">
                    Actively seeking new opportunities to grow as a React developer
                  </p>
                </div>
              </ScrollReveal>
            </div>
          ...
          <div className="section-container">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-4 md:mb-0">
                <ScrollReveal>
                  <h3 className="text-xl font-bold gradient-text">Paresh Bavaliya</h3>
                </ScrollReveal>
              ...
              <ScrollReveal delay={400}>
                <div className="flex space-x-6">
                  <a 
                    href="https://github.com/Paresh-Bavaliya" 
                    target="_blank" 
            ...
            <ScrollReveal delay={600}>
              <div className="text-center text-sm text-gray-500 mt-8">
                © {new Date().getFullYear()} Paresh Bavaliya. All rights reserved.
              </div>
            </ScrollReveal>
          </div>
        </footer>
