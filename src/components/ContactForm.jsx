...
const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      emailjs
        .send(
          "service_272xgdi", // Replace with your EmailJS Service ID
          "template_uin4hbh", // Replace with your EmailJS Template ID
          {
            name: formData.name,
            email: formData.email,
            message: formData.message,
          },
          "gT3WgjWqfaHVKAUII" // Replace with your EmailJS Public Key
        )
        .then(
          () => {
      ...
      <ScrollReveal animation="fade-in-left">
        <div className="space-y-8">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Feel free to contact me for any project inquiries or just to say
            hello! I'm always open to discussing new opportunities and ideas.
          </p>
